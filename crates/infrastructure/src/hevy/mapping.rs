...
pub fn lookup(template_id: &str) -> Option<Mapped> {
    let mapped = match template_id {
        ...
        "5c98d763-9ceb-412c-8365-18110f9d5897" => {
            duration(DurationExercise::NinetyNinety, LoadReading::Relative)
        } // 90/90 (28)
        "e2182af0-2577-4603-8e70-18273be1d48b" => {
            duration(DurationExercise::CouchStretch, LoadReading::Relative)
        } // Couch Stretch (28)
        "091737FA" => reps(
            RepsExercise::BackExtensionWeightedHyperextension,
            LoadReading::Relative,
        ...
        "118ed850-2aa7-4010-ab93-bdf8b0352660" => {
            reps(RepsExercise::HammerTwists, LoadReading::Relative)
        } // Hammer Twists (24)
        "4E5257DE" => reps(
        ...
        "fb0ab15d-b64e-4aaa-9028-cf8d28380697" => {
            reps(RepsExercise::WallClimbs, LoadReading::Relative)
        } // Wall Climbs (6)
        ...
        "ca868acf-25c1-4537-b0f5-08850d79665d" => {
            reps(RepsExercise::PikePullThrough, LoadReading::Relative)
        } // Pike Pull Through (5)
        ...
        "7014f03f-04d9-4b0b-90bc-adcdbc958fba" => {
            reps(RepsExercise::RingPushups, LoadReading::Relative)
        } // Ring Pushups (4)
        "aa6ea7c8-197d-4895-ac2a-a3ee9877d027" => {
            reps(RepsExercise::RingRows, LoadReading::Relative)
        } // Ring Rows (4)
        ...
        "1479354e-a862-42dd-87e3-3f0ecaa7c8c0" => {
            reps(RepsExercise::DeficitPushups, LoadReading::Relative)
        } // Deficit Pushups (3)
        ...
        "4f870422-92aa-4fb9-8ee5-12352c1dfe50" => {
            reps(RepsExercise::SleeperStretch, LoadReading::Relative)
        } // Sleeper Stretch (3)
        ...
        "0b9db86f-666c-46fd-b567-2918c3c269cd" => {
            reps(RepsExercise::SerratusRock, LoadReading::Relative)
        } // Serratus Rock (1)
        _ => return None,
    };
    Some(mapped)
